...
class LSTM_DDDQN(nn.Module):
    def __init__(self, input_dim, action_dim, hidden_dim=256, num_layers=2, head_hidden_dim=128):
        ...
        # 1. Market Branch (Raw values, no One-Hot)
        # self.market_embed_dim = self.raw_market_dim * 5 (Removed)
    ...
    def forward(self, x):
        ...
        market_flat = market_part # NEW: RAW FEATURES
